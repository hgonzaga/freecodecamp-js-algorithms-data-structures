...
Note that the rating values are saved as strings in the object and need to be converted into numbers before they are
used in any mathematical operations.
...
function getRating(watchList) {
    ...
    const nolanMovies = watchList
        .filter(movie => movie['Director'] === 'Christopher Nolan')
    const imdbRatingSum = nolanMovies
        .reduce((sum, movie) => sum + parseFloat(movie.imdbRating), 0)
    return imdbRatingSum / nolanMovies.length;
